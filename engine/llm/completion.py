...
from engine.llm.usage import extract_usage_details, set_last_usage_details
    ...
    async def complete(
        ...
        *,
        ...
        with observe(
            ...
            set_last_usage_details(usage_details)
...
_CHAT_SERVICE = ChatCompletionService()
_STRUCTURED_SERVICE = StructuredCompletionService()
...
async def chat_completion(
    ...
    return await _CHAT_SERVICE.complete(
        client=client,
        messages=messages,
        tools=tools,
        model=model,
...
async def structured_completion(
    ...
    return await _STRUCTURED_SERVICE.complete(
        client=client,
        messages=messages,
